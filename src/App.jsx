...
const saveKey = 'event-trip-alert.saved'
const postKey = 'event-trip-alert.posts'
const alerts = [
  {
    "id": "event-trip-alert-1",
    "title": "ライブ alert seed 1",
    "area": "名古屋",
    "category": "ライブ",
    "score": 95,
    "summary": "ライブ、スポーツ、展示会の開催日から宿、交通、周辺飲食、グッズへつなげる遠征通知サービス。 ライブの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "event-trip-alert-2",
    "title": "スポーツ alert seed 2",
    "area": "東京",
    "category": "スポーツ",
    "score": 92,
    "summary": "ライブ、スポーツ、展示会の開催日から宿、交通、周辺飲食、グッズへつなげる遠征通知サービス。 スポーツの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "event-trip-alert-3",
    "title": "展示会 alert seed 3",
    "area": "大阪",
    "category": "展示会",
    "score": 89,
    "summary": "ライブ、スポーツ、展示会の開催日から宿、交通、周辺飲食、グッズへつなげる遠征通知サービス。 展示会の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "event-trip-alert-4",
    "title": "宿泊 alert seed 4",
    "area": "静岡",
    "category": "宿泊",
    "score": 86,
    "summary": "ライブ、スポーツ、展示会の開催日から宿、交通、周辺飲食、グッズへつなげる遠征通知サービス。 宿泊の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">ライブ・イベント遠征アラート</p>
          <h1>Event Trip Alert</h1>
          <p className="lead">ライブ、スポーツ、展示会の開催日から宿、交通、周辺飲食、グッズへつなげる遠征通知サービス。</p>
        </div>
        <aside className="hero-panel">
          <span>eventtripalert.jp / event-trip-alert</span>
